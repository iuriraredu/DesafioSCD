...
public class ReportUtils implements BeforeAllCallback, AfterAllCallback, BeforeTestExecutionCallback, AfterTestExecutionCallback{
    ...
    public void beforeAll(ExtensionContext context){
        if (extent == null){
            String reportName = PropertiesConfig.getReporName() + "_" + dtf.format(LocalDateTime.now()) + ".html";
            ExtentSparkReporter spark = new ExtentSparkReporter(PropertiesConfig.getReporPath() + reportName);
